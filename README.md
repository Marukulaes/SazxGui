local library = {
	...
	colors = {
		main = Color3.fromRGB(255, 255, 255),--ขาว 
		background = Color3.fromRGB(0, 0, 0), --ดำ
		outerBorder = Color3.fromRGB(150, 25, 25),-- แดง
		innerBorder = Color3.fromRGB(0, 0, 0),--ดำ
		topGradient = Color3.fromRGB(0, 0, 0),--ดำ
		bottomGradient = Color3.fromRGB(0, 0, 0),--ดำ
		sectionBackground = Color3.fromRGB(0, 0, 0),--ดำ
		section = Color3.fromRGB(150, 25, 25),
		otherElementText = Color3.fromRGB(255, 255, 255), --ขาว 
		elementText = Color3.fromRGB(255, 255, 255),--ขาว 
